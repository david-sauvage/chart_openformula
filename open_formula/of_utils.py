...
def is_str_num_list(arg):
    """Verify if all classes present in the list are Strings, Numbers or CellReferences"""
    for i in arg:
...
def is_num_range_list(arg):
    """Verify if all classes present in the list are Numbers, CellReferences or RangeReferences"""
    for i in arg:
