...
#Logicals operations
    def test_of_and(self):
        ...
        self.assertEqual(of_and(LogicalExpression("2=2"), LogicalExpression("3>2")).str, "AND(2=2 ; 3>2)")
        self.assertRaises(TypeError, of_and, 2, 3)

    def test_of_or(self):
        self.assertEqual(of_or(LogicalExpression("1>2")).str, "OR(1>2)")
        self.assertEqual(of_or(LogicalExpression("2=2"), LogicalExpression("3>2")).str, "OR(2=2 ; 3>2)")
    ...
    def test_of_if(self):
        self.assertEqual(of_if(LogicalExpression("1>2"), Number("3"), Number("4")), "IF(1>2;3;4)")
